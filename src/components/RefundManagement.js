      ...
      <div style={{
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <input value={form.mobile} onChange={e => set("mobile", e.target.value)}
            style={{ width: "100%", border: "1px solid #e5e7eb", borderRadius: 8, padding: "10px 14px", fontSize: 14, color: "#111", outline: "none", boxSizing: "border-box" }} />
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, padding: "20px 22px" }}>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              ...
              <button
                onClick={() => { setCancelled(true); setApproved(false); }}
                style={{
                  background: "none",
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", background: "#f7f8fa", padding: isMobile ? "16px 14px" : "28px 32px" }}>
      ...
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, overflow: "hidden", padding: "16px 20px" }}>
        ...
        <RefundTable
          data={tabData}
          showPartnerCol={activeTab === "partner"}
          onView={handleView}
        />
      </div>
    </div>
