...
function Breadcrumb({ items }) {
  return (
    <div style={{ fontSize: 12, color: "#9ca3af", marginBottom: 20, display: "flex", gap: 4 }}>
      {items.map((item, i) => (
        <span key={i}>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: 340, boxShadow: "0 8px 32px rgba(0,0,0,0.18)", position: "relative",
      }}>
...
function CategoryList({ onView, onAdd }) {
      ...
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, overflow: "hidden" }}>
        <div style={{ padding: "14px 18px", borderBottom: "1px solid #f3f4f6" }}>
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, border: "1px solid #e5e7eb", borderRadius: 7, background: "#fff", padding: "6px 12px", fontSize: 12, color: "#374151", cursor: "pointer" }}>
              Status (All)
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#aaa" strokeWidth="2.5" strokeLinecap="round"><polyline points="6 9 12 15 18 9" /></svg>
            </div>
...
function CategoryDetail({ onBack, onEdit }) {
...
// ── SCREEN 3: ADD CATEGORY ────────────────────────────────────────────────────
function AddCategory({ onBack, isEdit }) {
      ...
      <div style={{ display: "flex", gap: 18, alignItems: "flex-start" }}>
        ...
        <div style={{ flex: 1, background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, padding: "20px 24px" }}>
          ...
          <div style={{ display: "flex", gap: 20, marginBottom: 20, alignItems: "flex-start" }}>
            <div style={{ width: 130, fontSize: 13, color: "#374151", paddingTop: 8, flexShrink: 0 }}>Category Name</div>
            <input
              value={name}
          ...
          <div style={{ display: "flex", gap: 20, marginBottom: 8, alignItems: "flex-start" }}>
            <div style={{ width: 130, fontSize: 13, color: "#374151", paddingTop: 8, flexShrink: 0 }}>Description</div>
            <div style={{ flex: 1 }}>
              <textarea
                value={desc}
