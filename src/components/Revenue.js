      ...
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10 }}>
        ...
        <div style={{ flex: 1, overflowY: "auto", background: "#f7f8fa", padding: isMobile ? "16px 14px" : "26px 30px" }}>
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            ...
            <button style={{
              background: "#111", color: "#fff", border: "none", borderRadius: 7,
              padding: "7px 22px", fontSize: 12, fontWeight: 600, cursor: "pointer",
            }}>
              Filter
            </button>
          </div>
        ...
        <div style={{
          ...
          alignItems: "center", gap: 12, fontSize: 12, color: "#6b7280",
        }}>
          ...
          <button
            ...
            style={{
              ...
              padding: "3px 7px", cursor: page === 1 ? "not-allowed" : "pointer",
          ...
          <button
            ...
            style={{
              background: "none", border: "1px solid #e5e7eb", borderRadius: 5,
              padding: "3px 7px", cursor: page >= totalPages ? "not-allowed" : "pointer",
