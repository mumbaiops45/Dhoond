      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, alignItems: "start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <Card title="Booking Summary">
            ...
            <Row label="Refund Status" valueEl={
              <span style={{
                fontSize: 12, fontWeight: 600, padding: "2px 10px", borderRadius: 4,
                background: booking.refundStatus === "Processed" ? "#dcfce7" : "#fef9c3",
                color: booking.refundStatus === "Processed" ? "#16a34a" : "#a16207"
              }}>
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", background: "#f7f8fa", padding: "28px 32px"}}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 22 }}>
        <h1 style={{ margin: 0,  color: "#111" }}>Cancelled Bookings</h1>
        <div style={{
      ...
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, overflow: "hidden" }}>
        ...
        {/* Controls — no Payment filter, matches screenshot */}
        <div style={{ padding: "16px 20px", borderBottom: "1px solid #f3f4f6" }}>
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            ...
            <div style={{
              ...
              borderRadius: 7, padding: "7px 12px", background: "#fafafa", minWidth: 200
            }}>
        ...
        {/* Table — Reason column instead of Payment/Amount */}
